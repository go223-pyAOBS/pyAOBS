...
int main(int argc, char** argv)
{
    ...
    char *corr_velfn=0, *corr_depfn=0;
    ...
    char *gravfn=0, contupfn[MaxStr], oceanUupfn[MaxStr], oceanUlofn[MaxStr];
    ...
    if (getDamp2d && wdv<=0){
	cerr << "-DQ requires -DV with a positive weight (wdv>0).\n";
	gotError=true;
    }
