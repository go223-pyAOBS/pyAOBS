...
c
     ...
     +    ,tshift(nsmax),amscal(nsmax),pick
c
...
c
	  ...
	  write(6,*) '#########################'
      write(6,1115) nsec
1115  format(i3,' OBSs   converted: '/
     +'    number      xmod')
      do 50 i=1,nsec	 
    	  write(6,8) nshot(i),xmod(i)
8         format(i10,f10.3)
50    continue
      write(6,*) '#########################'
c
...
c
      if(iamp.ne.0) then
	    write(6,3) (amscal(i),i=1,nsec)
3         format(/' amplitudes scale  is: ',100f8.5)
		write(6,*) 'amplitudes picks are: ',npicks
	  else
	    write(6,4) (tshift(i),i=1,nsec)
4         format(/' Time shift is: ',100f8.5)	  
